...
X_FOCUSS = KTFOCUSS_spiral(A,AT,Y,Low_Y,mask,Data,Pos,factor,lambda_focuss, Minner, Mouter);
...
X_res = KTFOCUSS_spiral(A,AT,Y-A(X_MEMC_tmp,mask),Low_Y,mask,Data-cart2spiral(A(X_MEMC_tmp,mask),Pos),Pos,factor,lambda_focuss, Minner, Mouter);
